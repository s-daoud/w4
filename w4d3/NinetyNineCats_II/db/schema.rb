...
ActiveRecord::Schema.define(version: 20160602002905) do
  ...
  create_table "session_lists", force: true do |t|
    t.integer  "user_id",       null: false
  ...
  add_index "session_lists", ["session_token"], name: "index_session_lists_on_session_token", unique: true, using: :btree
  add_index "session_lists", ["user_id"], name: "index_session_lists_on_user_id", using: :btree
